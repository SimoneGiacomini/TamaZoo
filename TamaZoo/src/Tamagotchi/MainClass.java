...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		if (InputDati.yesOrNo(PRESENTAZIONI_ZOO))
			System.out.println(TamaZoo.toStringMyZooNoParam());
		GiocaTamagotchi.usaTamagotchi();
		System.out.println(ARRIVEDERCI);
		// questo System.exit(0) e' qui in caso si richiami piu' volte il metodo main,
		// in quanto porterebbe a piu' output della string ARRIVEDERCI
		System.exit(0);
	}
