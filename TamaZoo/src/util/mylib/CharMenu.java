...
public class CharMenu extends MyMenu {
	...
	private static final String IMPOSSIBILE_CREARE_CHARMENU = "Impossibile creare un CharMenu con piu' di "+VOCI_DISPONIBILI+" voci. Verra' usato MyMenu";
	...
	/**attributo che capisce se e' possibile creare un CharMenu. In caso non sia possibile, esso crea un normale {@link MyMenu}*/
	...
	public void stampaMenu() {
		...
		String titoloCentrato = BelleStringhe.centrata(getTitolo(), LUNGHEZZA_RICHIESTA);
